...
//    
//    func getSessionId() {
//        TmDBService.instance.createSessionID(request_token: KeychainWrapper.standard.string(forKey: "SavedToken"), completion: { savedToken, sessionId in
...
//        TmDBService.instance.getAccountDetails(sessionIdQuery: KeychainWrapper.standard.string(forKey: "SessionId"), completion: { accountDetails in
//            DispatchQueue.main.async {
