...
class SeriesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        StatusBarUtil.instance.StatusBarBackgroundColor(endpoint: seriesView, color: UIColor.vibrantBlue)
    ...
    func getPopularSeriesList() {
        TmDBService.instance.getPopularSeries(completion: {popularSeries in
            for series in popularSeries {
                let seriesUIModel = SeriesUIModel(name: series.name, id: series.id, vote_average: String(series.vote_average), poster_path: series.poster_path, overview: series.overview, number_of_episodes: "", number_of_seasons: "", genres: "", episode_run_time: "", backdrop_path: "", dates: "", favorite: false)
